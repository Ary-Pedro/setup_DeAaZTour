...
class Agencia(models.Model):
    ...
    municipio = models.CharField(null=True, max_length=100, verbose_name="município",blank=True)
    cnpj = models.CharField(max_length=18, unique=True, null=True, verbose_name="CNPJ", blank=True)
    uf = models.CharField(null=True, max_length=2, verbose_name="UF",blank=True)
    logradouro = models.CharField(null=True,blank=True, max_length=255, verbose_name="logradouro", help_text="Rua | Avenida | Alameda | Travessa")
    numero = models.CharField(null=True, max_length=10, verbose_name="número",blank=True)
    complemento = models.CharField(max_length=255, null=True, blank=True, verbose_name="complemento")
    bairro = models.CharField(null=True, max_length=100, verbose_name="bairro",blank=True)
