...
class VendaForm(forms.ModelForm):
    ...
    custo_padrao_venda = forms.FloatField(
        ...
        widget=forms.TextInput(
            attrs={"placeholder": "Digite o Valor padrão da venda."}
        ),
    )
    desconto = forms.FloatField(
        ...
        widget=forms.TextInput(
            attrs={
                "placeholder": "Digite o desconto, será considerada em porcentagem (%)."
            }
        ),
    )
    custo_sobre_venda = forms.FloatField(
        ...
        widget=forms.TextInput(
            attrs={
                "placeholder": "Digite o custo sobre a venda decorrido da agencia ou afins."
            }
        ),
    )
    ...
    def clean(self):
        ...
        tipo_servico_valido = tipo_servico and tipo_servico.strip() in [
            item.strip() for item in OPC_SERVICES
        ]
...
class VendaAtualizar(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not self.instance.status_executivo:
            ...
            self.fields["executivo"].queryset = Funcionario.objects.filter(
                departamento="Exec"
            )
