...
urlpatterns = [
    ...
    # remover
    path(
        f"btn-complete/cliente/-<int:cpf>",
        views.Validar.as_view(),
        name="cliente_complete",
    ),
    path(
        "excluir-anexo/<int:anexo_id>/",
        views.excluir_anexo_cliente,
        name="excluir_anexo_cliente",
    ),
    # -------------------------------------------------------------------------------------------------------------------
]
