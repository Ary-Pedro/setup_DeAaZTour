...
urlpatterns = [
    ...
    # user views
    path(
        f"funcionario/atualizar/<int:pk>",
        views.UpdateView.as_view(),
        name="funcionario_atualizar",
    ),
    path(
        f"funcionario/<int:pk>", views.Desligar.as_view(), name="desligar_funcionario"
    ),
    path(
        f"funcionario/atualizar-Perfil/<int:pk>/",
        views.AtualizarPerfil.as_view(),
        name="atualizar_perfil",
    ),
    path(
        f"funcionario/listagem/",
        views.ListFuncionario.as_view(),
        name="ListagemFuncionario",
    ),
    # Buscas
    path(f"funcionario/buscar/", views.Procurar.as_view(), name="procurarFuncionario"),
    path(
        f"funcionario/buscar/dados/-<int:dados_id>",
        views.Dados.as_view(),
    ...
    path(
        "exportar-fluxo-concluido/<int:fluxo_id>/",
        views.salvar_csvFluxoConcluido,
        name="exportarFluxoConcluido",
    ),
    ...
    path(
        "fluxo/deletar-conta/<int:pk>/",
        views.deletar_conta_mensal,
        name="deletar_conta_mensal",
    ),
    path(
        "fluxo-completo/<int:pk>/",
        views.DetalhesFluxoMensalCompleto.as_view(),
        name="fluxo_completo",
    ),
    path(
        "fluxo/deletar-conta/<int:pk>/",
    ...
    path(
        "fluxo/completo/atualizar/<int:pk>/",
        views.FluxoUpdateView.as_view(),
        name="fluxo_atualizar",
    ),
]
